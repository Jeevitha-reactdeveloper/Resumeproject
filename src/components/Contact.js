...
const Contact = () => {
  return (
    <section className='flex flex-col bg-secondary px-5  py-35 min-h-[400px]' id='contacts'>
        <div className=' flex flex-col items-center  text-black py-35'>
            <h1 className='text-2xl md:text-4xl text-gray-700 border-b-4 mb-5 w-[140px] border-yellow-400 font-bold '>Contact</h1>
