...
function Header() {
  ...
  return (
    <header className='flex justify-between px-5 py-2 bg-primary '>
        <a href='#contact' className='text-2xl  md:text-3xl font-bold outline-none' >Jeevitha N</a>
            <nav className='hidden md:block'> 
                <ul className="flex font-bold md:text-xl text-white ">
                   <li> <a className='hover' href='/'>Home </a></li>
                    ...
                    <li><a className='hover' href='#skills'>Skills</a></li>
                    <li><a className='hover' href='#projects'>Projects</a></li>
                    <li><a className='hover' href='#contacts'>Contact</a></li>
                </ul>
            </nav>
