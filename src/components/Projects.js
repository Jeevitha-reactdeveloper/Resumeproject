...
const Projects = () => {
  return (
    ...
    <div className="w-full flex flex-col">
     <h1 className="text-2xl md:text-4xl mb-5 border-b-4 w-[95px] md:w-[140px] text-red-400 border-yellow-400 font-bold">Projects</h1>
    ...
    <div className="w-full">
        <div className='flex flex-col md:flex-row px-10 gap-5'>
            <div className='relative'>
              <img  className='h-[400px] w-[400px]' alt='to do' src={Todo}/>
            ...
            <div className='relative'>
              <img  className='h-[300px] w-[400px]' alt='userlogin' src={userlogin}/>
              <div className='absolute left-o right-0 bottom-0 top-0 bg-gray-500   opacity-0 hover:opacity-100 duration-500'>
                <p className='text-center py-6' >Login page is created using Regex login authentication.</p>
              </div>
            </div>
            <div className='relative'>
                <img className='h-[400px] w-[400px]' alt='socialmedia' src={Socialmedia}/>
               <div className='absolute left-o right-0 bottom-0 top-0 bg-gray-500  opacity-0 hover:opacity-100 duration-500'>
